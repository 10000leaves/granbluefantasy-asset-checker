...
export function ExportContentItems({
  ...
  return (
    <>
      ...
      {/* ユーザー情報 */}
      {filterSettings.showUserInfo &&
        sessionData?.inputValues &&
        Object.keys(sessionData.inputValues).length > 0 && (
          <Box sx={{ mb: 3 }}>
            <Typography
              variant="h6"
              gutterBottom
            ...
            {isPdfMode ? (
              ...
              <Box sx={{ px: 2 }}>
                <Grid container spacing={2}>
                  {Object.entries(sessionData.inputValues).map(
                    ([key, value]) => (
                  ...
                  <Grid item xs={6} sm={4} md={3} key={weapon.id}>
                    ...
                    >
                      ...
                      >
                        ...
                        {weapon.awakenings &&
                          Object.keys(weapon.awakenings).length > 0 &&
                          Object.entries(
                            weapon.awakenings as WeaponAwakenings,
                          ).map(([type, count]) => (
                            <Typography
                              key={type}
                              variant="caption"
